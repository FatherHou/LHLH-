						...
						<div id="userInformation" class="tab-pane">
                            <div style="width: auto;height: 8px"></div>
								...
								<div id="ai-imformation" >
									<p>ID:<input id="idInput" class="form-control" value="${user.user_id }" ></p>
									...
									<p>Actor:<input id="actorInput" class="form-control" value="${user.actor }" ></p>
									<br/>
									<button id="modify" class="btn btn-primary btn_search" onclick="hadduser()">modify</button>
								</div>
						</div>
        									...
        									if(birthday != ""){
        										if(email != ""){
			        								if(confirm("Are you sure to modify the personal imformation?")){
			        									modifyurl="AddUser?Name="+name+"&&Phone="+phone+"&&Password="+password+"&&Birthday="+birthday+"&&Email="+email+"&&Id="+id+"&&Actor="+actor;
